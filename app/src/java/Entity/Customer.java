...
public class Customer {
    ...
    /**
     * Creates a Customer object with specified username, password, name, age, gender, profession, facebookName and currentPoints
     * @param username the customer's username
     * @param password the customer's password
     * @param name the customer's name
    ...
    public Customer(String username, String password, String name, int age, char gender, String profession, String facebookName){
